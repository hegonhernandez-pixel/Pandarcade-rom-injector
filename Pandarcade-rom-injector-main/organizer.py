...
class PandoraUniversalManager:
    def __init__(self, log_callback=None):
        ...
        # Este diccionario ahora está correctamente dentro del __init__
        self.FORMATOS_POR_CONSOLA = {}
        
        # Este también está correctamente dentro del __init__
    ...
    # Ejemplo de un método que usa 'self' correctamente
    def log(self, mensaje):
        if self.log_callback:
            self.log_callback(mensaje)
        else:
            print(mensaje)# Diccionario maestro con mapeo exacto a tu captura de pantalla de Pandora
PANDORA_BIOS_MAP = {
